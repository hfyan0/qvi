...
###################################################
with open(config["general"]["prep_data_folder"]+"/symbol_with_enough_fundl.pkl", "rb") as symbol_with_enough_fundl_file:
...
# with open(config["general"]["prep_data_folder"]+"/hist_bps_dict.pkl", "r") as hist_bps_dict_file:
#     hist_bps_dict = cPickle.load(hist_bps_dict_file)
# with open(config["general"]["prep_data_folder"]+"/hist_eps_dict.pkl", "r") as hist_eps_dict_file:
#     hist_eps_dict = cPickle.load(hist_eps_dict_file)
# with open(config["general"]["prep_data_folder"]+"/hist_roa_dict.pkl", "r") as hist_roa_dict_file:
#     hist_roa_dict = cPickle.load(hist_roa_dict_file)
# with open(config["general"]["prep_data_folder"]+"/hist_totliabps_dict.pkl", "r") as hist_totliabps_dict_file:
